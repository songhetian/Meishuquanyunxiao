...
class TimRestAPI extends TimRestInterface
{
	...
	function group_get_group_member_info2($group_id)
	{
	...
	function group_modify_group_base_info3($group_id, $app_define_list)
	{
	...
	function group_modify_group_base_info4($group_id, $info_set)
	{
