 ...
 */
class WechatOrder extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['appid', 'mch_id', 'device_info', 'nonce_str', 'sign', 'out_trade_no', 'goods_tag', 'product_id', 'limit_pay','user_type'], 'string', 'max' => 32],
