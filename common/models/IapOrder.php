 ...
 */
class IapOrder extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['user_id', 'user_type', 'membership_type','product_id', 'quantity','transaction_id','purchase_date','app_item_id','create_time'], 'safe'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'membership_type' => Yii::t('app', '购买会员类型'),
