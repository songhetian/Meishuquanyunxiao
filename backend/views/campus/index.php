...
<div id="content" class="col-md-12">
    <div class="pageheader"> 
        <h2><i class="fa fa-home"></i> <?= Yii::t('backend', 'Campuses') ?> </h2> 
              ...
              <div class="tile-body color transparent-black rounded-corners">
                <p>
                    <?php if(Yii::$app->user->can(Yii::$app->controller->id . '/create')) : ?>
                        <?= Html::a(Yii::t('backend', 'Create Campus'), ['create'], ['class' => 'btn btn-success']) ?>
                    <?php endif; ?>
                </p>
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'attribute' => 'status',
                                'filter' => Campus::getValues('status'),
                                'enum' =>  Campus::getValues('status')
                            ],
                            [
                                ...
                                'buttons' => [
                                    'delete' => function ($url, $model, $key) {
                                        if($model->is_main == $model::MAIN_NOT_YET){
