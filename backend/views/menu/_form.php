...
<div class="menu-form">
    ...
    <div class="icon">
        ...
        <h1><i class="fa fa-pencil"></i><span class="flag"></span></h1>
        <h1><i class="fa fa-book"></i><span class="flag"></span></h1>
        <h1><i class="fa fa-camera"></i><span class="flag"></span></h1>
        <h1><i class="fa fa-home"></i><span class="flag"></span></h1>
...
<script>
  function display(){
      pid = $("#menu-pid").find('option:selected').val();
      if(pid == 0){
