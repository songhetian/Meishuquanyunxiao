...
<div class="user-form">
    ...
    <?= $form->field($model, 'url')->textInput(['maxlength' => true]) ?>
        ...
        if(!empty($model->thumbnails)){
            echo "<img src='".OSS::getUrl(Campus::findOne(Admin::findOne($model->admin_id)->campus_id)->studio_id,'prointroduction','thumbnails',$model->thumbnails).Yii::$app->params['oss']['Size']['original']."' width='200' height='200'/>";
        }
    ?>
    <br/>
...
<script type="text/javascript">
    ...
    $('#prointroduction-timing_push_time').datetimepicker();
    </script>
