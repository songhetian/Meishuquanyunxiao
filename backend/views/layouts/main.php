...
<html>
  ...
  <head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= Format::getStudio('name').Html::encode(Yii::$app->name) ?></title>
    <?php $this->head() ?>
    <style type="text/css">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-header col-md-2">
            <a class="navbar-brand" href="<?= Yii::$app->homeUrl ?>">
              <strong>
                <?= Format::getStudio('name').Html::encode(Yii::$app->name) ?>
              </strong>
            </a>
            ...
            <ul class="nav navbar-nav quick-actions" >
                <li class="dropdown divided user" id="current-user">
                  ...
                  <?php
                    ...
                    $role_name = $role[key($role)]->description;
                  ?>
                  <?= Html::a(
                    Yii::$app->user->identity->name . '【' . $role_name . '】',
                    //Yii::$app->user->identity->name.'<i class="fa fa-caret-down"></i>',
                    'javascript:void(0);',
