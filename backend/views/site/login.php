...
<head>
    ...
    <?php $this->head() ?>
    <style type="text/css">
    	.help-block{float:right; margin-top:-27px; margin-right:5px;}
    </style>
</head>
			...
			<div class="row">
				<div id="content" class="col-md-12 full-page login">
					<div class="inside-block">
						...
						<h1><strong><?= $name.Html::encode(Yii::$app->name) ?></strong></h1>
						...
						<section>
							<div class="input-group">
							  <?= $form->field($model, 'phone_number')->textInput(['autofocus' => true,'class'=>'form-control','placeholder'=>'请输入手机号']) ?>
