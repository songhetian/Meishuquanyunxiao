...
<div id="content" class="col-md-12">
    <div class="pageheader"> 
        <h2><i class="fa fa-camera"></i> <?= Yii::t('backend', 'Pictures') ?> </h2> 
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'attribute' => 'source',
                                'filter' => Picture::getValues('source'),
                                'enum' => Picture::getValues('source')
                            ],
                            */
                            //'name',
                            //'metis_material_id',
                            ...
                            */
                            [
                               ...
                               'value' => function($model) {
                                    ...
                                    return ($model->image) ? Html::img(
                                        ($model->source == $model::SOURCE_LOCAL) ? Oss::getUrl($studio, 'picture', 'image', $model->image).$size : $model->image.$size
                                    ) : $model->image;
                                }
                            ],
                            'watch_count',
                            ...
                            [
                                'class' => EnumColumn::className(),
                                'attribute' => 'is_public',
                                'filter' => Picture::getValues('is_public'),
                                'enum' => Picture::getValues('is_public')
                            ],
                            */
                            [
                            ...
                            [
                                'class' => EnumColumn::className(),
                                'attribute' => 'status',
                                'filter' => Picture::getValues('status'),
                                'enum' => Picture::getValues('status')
                            ],
                            */
                            [
