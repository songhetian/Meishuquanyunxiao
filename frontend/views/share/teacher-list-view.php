...
<head>
    ...
    <title><?php echo $teacher_list->name ?></title>
    <link rel="Shortcut Icon" href="<?php echo $teacher_list->pic_url ?>" />
...
<div style='background-color:rgba(34,34,34,.8);height: 50px;width:100%;'>
    ...
    <div class="main fontSize2">
        <p class="title" align="left">
            <?php echo $teacher_list->name ?>
        </p>
        <span class="src">
            <?php echo date("Y-m-d H:i:s",$teacher_list->created_at); ?>&nbsp;&nbsp;<?php //echo @$teacher_list->studio_id ?>
        </span>
        <div class="text">
          <img src = " <?php echo $image;?>" />
            <?php echo @$teacher_list->desc ?>
        </div>
    </div>
</body>
