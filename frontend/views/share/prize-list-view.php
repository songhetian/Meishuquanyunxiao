...
<head>
    ...
    <title><?php echo $prize_list->name ?></title>
    <link rel="Shortcut Icon" href="<?php echo $prize_list->thumbnails ?>" />
...
<div style='background-color:rgba(34,34,34,.8);height: 50px;width:100%;'>
    ...
    <div class="main fontSize2">
        <p class="title" align="left">
            <?php echo $prize_list->name ?>
        </p>
        <span class="src">
            <?php echo date("Y-m-d H:i:s",$prize_list->created_at); ?>&nbsp;&nbsp;<?php //echo @$prize_list->studio_id ?>
        </span>
        <div class="text">
            <?php echo @$prize_list->desc ?>
        </div>
    </div>
</body>
