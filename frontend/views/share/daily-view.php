...
<head>
    ...
    <title><?php echo $daily->content ?></title>
...
<a href="https://a.app.qq.com/o/simple.jsp?pkgname=com.meishuquanyunxiao.artworld&fromcase=40003">
...
<!-- 
    ...
    <div class="main fontSize2">
        <p class="title" align="left">
            <?php echo $daily->content ?>
        </p>
        <span class="src">
            <?php echo date("Y-m-d H:i:s",$daily->timer); ?>&nbsp;&nbsp;<?php //echo @$daily->studio_id ?>
        </span>
        <div class="text">
            <?php 
