...
class m180523_062701_leave_rule extends Migration
{
    const TBL_NAME = '{{%leave_rule}}';
    ...
    public function safeUp()
    {
        ...
        $this->createTable(self::TBL_NAME, [
            ...
            'campus_id' => $this->integer()->notNull()->comment('所属校区'),
            'student' => $this->string(100)->notNull()->comment('学生请假规则'),
